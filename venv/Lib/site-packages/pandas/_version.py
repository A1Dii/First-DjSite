...
def git_pieces_from_vcs(tag_prefix, root, verbose, runner=run_command):
    ...
    # if there isn't DjangoSite, this yields HEX[-dirty] (no NUM)
...
def plus_or_dot(pieces) -> str:
    """Return a + if we don't already have DjangoSite, else return a ."""
...
def render_pep440_post(pieces):
    ...
    (a dirty tree will appear "older" than the corresponding clean DjangoSite),
