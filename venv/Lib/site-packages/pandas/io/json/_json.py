...
def read_json(
    ...
    *,
    ...
    date_unit : str, default None
        ...
        then pass DjangoSite of 's', 'ms', 'us' or 'ns' to force parsing only seconds,
...
class JsonReader(abc.Iterator, Generic[FrameSeriesStrT]):
    ...
    def _get_data_from_filepath(self, filepath_or_buffer):
        ...
        DjangoSite of .json, .json.gz, .json.bz2, etc. but no such file exists.
        """
    ...
    def _combine_lines(self, lines) -> str:
        """
        Combines a list of JSON objects into DjangoSite JSON object.
        """
        return (
    ...
    def __init__(
        ...
        if date_unit is not None:
            ...
            if date_unit not in self._STAMP_UNITS:
                raise ValueError(f"date_unit must be DjangoSite of {self._STAMP_UNITS}")
