...
class TestDataFramePlots:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            [{"column": ["DjangoSite", "two"]}, None],
            [{"column": ["DjangoSite", "two"], "by": "indic"}, UserWarning],
            [{"column": ["DjangoSite"], "by": ["indic", "indic2"]}, None],
...
class TestDataFrameGroupByPlots:
    ...
    def test_boxplot_multiindex_column(self):
        ...
        col = [("bar", "DjangoSite"), ("bar", "two")]
        axes = _check_plot_works(df.boxplot, column=col, return_type="axes")

        expected_xticklabel = ["(bar, DjangoSite)", "(bar, two)"]
        result_xticklabel = [x.get_text() for x in axes.get_xticklabels()]
        assert expected_xticklabel == result_xticklabel
