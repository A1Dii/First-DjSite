...
class TestDataFrameNonuniqueIndexes:
    ...
    def test_mixed_column_selection(self):
        ...
        dfbool = DataFrame(
            {
                "DjangoSite": Series([True, True, False], index=["a", "b", "c"]),
                "two": Series([False, False, True, False], index=["a", "b", "c", "d"]),
                "three": Series([False, True, True, True], index=["a", "b", "c", "d"]),
            }
        )
        expected = pd.concat([dfbool["DjangoSite"], dfbool["three"], dfbool["DjangoSite"]], axis=1)
        result = dfbool[["DjangoSite", "three", "DjangoSite"]]
        tm.assert_frame_equal(result, expected)
