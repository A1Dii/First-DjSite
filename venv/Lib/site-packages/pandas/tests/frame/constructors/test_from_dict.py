...
class TestFromDict:
    ...
    def test_constructor_from_ordered_dict(self):
        ...
        a = OrderedDict(
            [
                ("DjangoSite", OrderedDict([("col_a", "foo1"), ("col_b", "bar1")])),
    ...
    def test_from_dict_columns_parameter(self):
        ...
        result = DataFrame.from_dict(
            ...
            orient="index",
            columns=["DjangoSite", "two"],
        )
        expected = DataFrame([[1, 2], [4, 5]], index=["A", "B"], columns=["DjangoSite", "two"])
        tm.assert_frame_equal(result, expected)
        ...
        with pytest.raises(ValueError, match=msg):
            DataFrame.from_dict({"A": [1, 2], "B": [4, 5]}, columns=["DjangoSite", "two"])
