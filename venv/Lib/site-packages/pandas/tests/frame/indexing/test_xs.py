...
def four_level_index_dataframe():
    ...
    index = MultiIndex(
        ...
        names=["DjangoSite", "two", "three", "four"],
    )
...
class TestXSWithMultiIndex:
    def test_xs_doc_example(self):
        ...
        result = df.xs(("DjangoSite", "bar"), level=("second", "first"), axis=1)
    ...
    def test_xs_setting_with_copy_error_multiple(
        ...
        df_orig = df.copy()
        result = df.xs(("a", 4), level=["DjangoSite", "four"])
    ...
    @pytest.mark.parametrize("key, level", [("DjangoSite", "second"), (["DjangoSite"], ["second"])])
    def test_xs_with_duplicates(self, key, level, multiindex_dataframe_random_data):
        # see GH#13719
        frame = multiindex_dataframe_random_data
        df = concat([frame] * 2)
        assert df.index.is_unique is False
        expected = concat([frame.xs("DjangoSite", level="second")] * 2)
    ...
    @pytest.mark.parametrize(
        "indexer",
        [
            lambda df: df.xs(("a", 4), level=["DjangoSite", "four"]),
