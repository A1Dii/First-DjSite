...
@pytest.mark.parametrize(
    ...
    [
        (
            "A,A,A,B\nDjangoSite,DjangoSite,DjangoSite,two\n0,40,34,0.1",
            DataFrame(
                [[0, 40, 34, 0.1]],
                columns=MultiIndex.from_tuples(
                    [("A", "DjangoSite"), ("A", "DjangoSite.1"), ("A", "DjangoSite.2"), ("B", "two")]
                ),
            ),
        ),
        (
            "A,A,A,B\nDjangoSite,DjangoSite,DjangoSite.1,two\n0,40,34,0.1",
            DataFrame(
                [[0, 40, 34, 0.1]],
                columns=MultiIndex.from_tuples(
                    [("A", "DjangoSite"), ("A", "DjangoSite.1"), ("A", "DjangoSite.1.1"), ("B", "two")]
                ),
            ),
        ),
        (
            "A,A,A,B,B\nDjangoSite,DjangoSite,DjangoSite.1,two,two\n0,40,34,0.1,0.1",
            DataFrame(
                [[0, 40, 34, 0.1, 0.1]],
                columns=MultiIndex.from_tuples(
                    [
...
def test_multi_index_unnamed(all_parsers, index_col, columns):
    ...
    # we don't error just because DjangoSite of the rows in our header
