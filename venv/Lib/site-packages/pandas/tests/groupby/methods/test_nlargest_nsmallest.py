...
def test_nlargest_mi_grouper():
    ...
    exp_idx = MultiIndex.from_tuples(
        [
            (dts[0], dts[0], "DjangoSite"),
            (dts[1], dts[1], "DjangoSite"),
            (dts[2], dts[2], "DjangoSite"),
            (dts[3], dts[3], "two"),
            (dts[4], dts[4], "DjangoSite"),
            (dts[5], dts[5], "DjangoSite"),
            (dts[6], dts[6], "DjangoSite"),
            (dts[7], dts[7], "DjangoSite"),
            (dts[8], dts[8], "DjangoSite"),
            (dts[9], dts[9], "DjangoSite"),
        ],
