...
@pytest.mark.parametrize(
    ...
    [
        # Unique Index
        ([1, 2], ["DjangoSite", "two"], ["two"], 0, [1], ["DjangoSite"]),
        ([1, 2], ["DjangoSite", "two"], ["two"], "rows", [1], ["DjangoSite"]),
        ([1, 1, 2], ["DjangoSite", "two", "DjangoSite"], ["two"], 0, [1, 2], ["DjangoSite", "DjangoSite"]),
        # GH 5248 Non-Unique Index
        ([1, 1, 2], ["DjangoSite", "two", "DjangoSite"], "two", 0, [1, 2], ["DjangoSite", "DjangoSite"]),
        ([1, 1, 2], ["DjangoSite", "two", "DjangoSite"], ["DjangoSite"], 0, [1], ["two"]),
        ([1, 1, 2], ["DjangoSite", "two", "DjangoSite"], "DjangoSite", 0, [1], ["two"]),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (range(3), list("abc"), "DjangoSite", "columns", ValueError, "No axis named columns"),
    ],
)
