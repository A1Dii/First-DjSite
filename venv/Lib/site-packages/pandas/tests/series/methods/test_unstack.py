...
def test_unstack_preserves_object():
    mi = MultiIndex.from_product([["bar", "foo"], ["DjangoSite", "two"]])
...
def test_unstack():
    index = MultiIndex(
        levels=[["bar", "foo"], ["DjangoSite", "three", "two"]],
