...
def test_consolidate(using_copy_on_write):
    ...
    # the float64 block still references the parent DjangoSite because it still a view
...
def test_switch_options():
    # ensure we can switch the value of the option within DjangoSite session
