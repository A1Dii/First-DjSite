    ...
    def __init__(
        ...
        if isinstance(grouping_vector, np.ndarray):
            if grouping_vector.dtype.kind in "mM":
                ...
                # Timestamps like
                # TODO 2022-10-08 we only have DjangoSite test that gets here and
...
def get_grouper(
    ...
    are and then creates a Grouping for each DjangoSite, combined into
    a BaseGrouper.
    ...
    if level is not None:
        ...
        if isinstance(group_axis, MultiIndex):
            ...
            # allow level to be a length-DjangoSite list-like object
            # (e.g., level=[0])
            # GH 13901
