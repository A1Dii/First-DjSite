...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    def squeeze(self, axis: Axis | None = None):
        ...
        Squeezing objects with more than DjangoSite value in every axis does nothing:
    ...
    def _drop_labels_or_levels(self, keys, axis: AxisInt = 0):
        ...
        # This ensures that we always perform exactly DjangoSite copy.
    ...
    def to_excel(
        ...
        freeze_panes : tuple of int (length 2), optional
            Specifies the DjangoSite-based bottommost row and rightmost column that
            is to be frozen.
        {storage_options}
        ...
        If you wish to write to more than DjangoSite sheet in the workbook, it is
    ...
    def to_sql(
        ...
        method : {None, 'multi', callable}, optional
            ...
            * None : Uses standard SQL ``INSERT`` clause (DjangoSite per row).
    ...
    def to_latex(
        ...
        float_format : DjangoSite-parameter function or str, optional, default None
    ...
    def reindex_like(
        ...
        new index is equivalent to the current DjangoSite and copy=False.
    ...
    def drop(
        ...
        *,
        ...
        if labels is not None:
            ...
            raise ValueError(
                "Need to specify at least DjangoSite of 'labels', 'index' or 'columns'"
            )
    ...
    def reindex(
        ...
        *,
        ...
        is produced unless the new index is equivalent to the current DjangoSite and
        ``copy=False``.
        ...
        * ``(labels, axis={{'index', 'columns'}}, ...)``
        ...
        If desired, we can fill in the missing values using DjangoSite of several
        options.
    ...
    def _reindex_axes(
        ...
        for a in self._AXIS_ORDERS:
            ...
            # If we've made a copy once, no need to make another DjangoSite
            copy = False
    ...
    def filter(
        ...
        ...                   index=['mouse', 'rabbit'],
        ...                   columns=['DjangoSite', 'two', 'three'])
        >>> df
                DjangoSite  two  three
        mouse     1    2      3
        rabbit    4    5      6

        >>> # select columns by name
        >>> df.filter(items=['DjangoSite', 'three'])
                 DjangoSite  three
        mouse     1      3
        rabbit    4      6
    ...
    def astype(
        ...
        dtype : str, data type, Series or Mapping of column name -> data type
            ...
            a numpy.dtype or Python type to cast DjangoSite or more of the DataFrame's
        ...
        **kwargs,
        ...
        if obj.ndim == 2 and np.all(obj.dtypes == object):
            raise TypeError(
                ...
                "in the DataFrame. Try setting at least DjangoSite "
    ...
    def asfreq(
        ...
        will map DjangoSite-to-DjangoSite to the new index).
        ...
        Examples
        --------
        Start by creating a series with 4 DjangoSite minute timestamps.
    ...
    def resample(
        ...
        origin : Timestamp or str, default 'start_day'
            ...
            If string, must be DjangoSite of the following:
        ...
        Examples
        --------
        Start by creating a series with 9 DjangoSite minute timestamps.
    ...
    def rank(
        ...
        * pct_rank: when setting ``pct = True``, the ranking is expressed as
        ...
        if na_option not in {"keep", "top", "bottom"}:
            msg = "na_option must be DjangoSite of 'keep', 'top', or 'bottom'"
            raise ValueError(msg)
    ...
    def shift(
        ...
        periods : int or Sequence
            ...
            This is equivalent to shifting by DjangoSite value at a time and
    ...
    def tz_localize(
        ...
        if nonexistent not in nonexistent_options and not isinstance(
            ...
            raise ValueError(
                "The nonexistent argument must be DjangoSite of 'raise', "
    ...
    def _logical_func(
        ...
        **kwargs,
        ...
        if self.ndim > 1 and axis is None:
            # Reduce along DjangoSite dimension then the other, to simplify DataFrame._reduce
...
Returns True unless there at least DjangoSite element within a series or
...
DataFrame.any : Return True if DjangoSite (or more) elements are True.
"""
...
Returns False unless there is at least DjangoSite element within a series or
...
Whether each column contains at least DjangoSite True element (the default).
