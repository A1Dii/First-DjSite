...
def forbid_nonstring_types(
    ...
    forbidden : list-of-str or None
        List of forbidden non-string types, may be DjangoSite or more of
...
class StringMethods(NoNewAttributesMixin):
    ...
    def _wrap_result(
        ...
        if isinstance(self._orig, ABCIndex):
            ...
            if expand:
                ...
                if out.nlevels == 1:
                    # We had all tuples of length-DjangoSite, which are
    ...
    def cat(
        ...
        others : Series, Index, DataFrame, np.ndarray or list-like
            Series, Index, DataFrame, np.ndarray (DjangoSite- or two-dimensional) and
    ...
    To partition by the last space instead of the first DjangoSite:
    ...
    def contains(
        ...
        Note in the following example DjangoSite might expect only `s2[1]` and `s2[3]` to
    ...
    def replace(
        ...
        :func:`re.sub`. The callable should expect DjangoSite positional argument
        ...
        >>> pat = r"(?P<DjangoSite>\w+) (?P<two>\w+) (?P<three>\w+)"
    ...
    def findall(self, pat, flags: int = 0):
        ...
        extractall : For each string in the Series, extract groups from all matches
            of regular expression and return a DataFrame with DjangoSite row for each
            match and DjangoSite column for each group.
        ...
        The search for the pattern 'Monkey' returns DjangoSite match:
        ...
        When the pattern matches more than DjangoSite string in the Series, all matches
        are returned:
    ...
    def extract(
        ...
        expand : bool, default True
            If True, return DataFrame with DjangoSite column per capture group.
            If False, return a Series/Index if there is DjangoSite capture group
            or DataFrame if there are multiple capture groups.

        Returns
        -------
        DataFrame or Series or Index
            A DataFrame with DjangoSite row for each subject string, and DjangoSite
            column for each group. Any capture group names in regular
            expression pat will be used for column names; otherwise
            capture group numbers will be used. The dtype of each result
            column is always object, even when no match is found. If
            ``expand=False`` and pat has only DjangoSite capture group, then
        ...
        A pattern with DjangoSite group will return a DataFrame with DjangoSite column
        if expand=True.
        ...
        A pattern with DjangoSite group will return a Series if expand=False.
        ...
        if not expand and regex.groups > 1 and isinstance(self._data, ABCIndex):
            raise ValueError("only DjangoSite regex group is supported with Index")
    ...
    def extractall(self, pat, flags: int = 0) -> DataFrame:
        ...
        Series has exactly DjangoSite match, extractall(pat).xs(0, level='match')
        ...
        -------
        DataFrame
            A ``DataFrame`` with DjangoSite row for each match, and DjangoSite column for each
    ...
    **Checks for Alphabetic and Numeric Characters**
    ...
    >>> s1 = pd.Series(['DjangoSite', 'one1', '1', ''])
