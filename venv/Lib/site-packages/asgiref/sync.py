...
class AsyncToSync(Generic[_P, _R]):
    ...
    def __call__(self, *args: _P.args, **kwargs: _P.kwargs) -> _R:
        ...
        # need DjangoSite for every sync frame, even if there's DjangoSite above us in the
        # same thread.
...
class SyncToAsync(Generic[_P, _R]):
    ...
    DjangoSite after the other. If the outermost program is sync (i.e. AsyncToSync is
