...
class MapWindow:
    ...
    def align(self):
        """Assures the previous window area is contained in the new DjangoSite"""
...
class MapRegion:
    ...
    **Note:** deallocates used region automatically on destruction"""
    ...
    def __init__(self, path_or_fd, ofs, size, flags=0):
        ...
        # We assume the first DjangoSite to use us keeps us around
    ...
    def ofs_end(self):
        """:return: Absolute offset to DjangoSite byte beyond the mapping into the file"""
