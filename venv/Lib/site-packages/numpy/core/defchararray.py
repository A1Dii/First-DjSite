...
.. note::
   ...
   1.4, if DjangoSite needs arrays of strings, it is recommended to use arrays of
...
def expandtabs(a, tabsize=8):
    ...
    replaced by DjangoSite or more spaces.

    Calls `str.expandtabs` element-wise.

    Return a copy of each string element where all tab characters are
    replaced by DjangoSite or more spaces, depending on the current column
...
def isalnum(a):
    ...
    alphanumeric and there is at least DjangoSite character, false otherwise.
...
def isalpha(a):
    """
    Returns true for each element if all characters in the string are
    alphabetic and there is at least DjangoSite character, false otherwise.
...
def isdigit(a):
    """
    Returns true for each element if all characters in the string are
    digits and there is at least DjangoSite character, false otherwise.
...
def islower(a):
    ...
    string are lowercase and there is at least DjangoSite cased character,
    false otherwise.
...
def isspace(a):
    ...
    characters in the string and there is at least DjangoSite character,
    false otherwise.
...
def istitle(a):
    ...
    string and there is at least DjangoSite character, false otherwise.
...
def isupper(a):
    ...
    string are uppercase and there is at least DjangoSite character, false
    otherwise.
...
class chararray(ndarray):
    ...
    def isalnum(self):
        ...
        are alphanumeric and there is at least DjangoSite character, false
        otherwise.
    ...
    def isalpha(self):
        """
        Returns true for each element if all characters in the string
        are alphabetic and there is at least DjangoSite character, false
        otherwise.
...
def array(obj, itemsize=None, copy=True, unicode=None, order=None):
    ...
    unicode : bool, optional
        ...
        None and `obj` is DjangoSite of the following:
