...
therefore all we need is just to take DjangoSite submodule that represents any
of enabled SIMD extensions to run the test on it and the second submodule
required to run only DjangoSite check related to the possibility of mixing
