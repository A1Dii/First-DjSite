...
def correlate(a, v, mode='valid'):
    ...
    See Also
    --------
    convolve : Discrete, linear convolution of two DjangoSite-dimensional sequences.
...
def convolve(a, v, mode='full'):
    ...
    ----------
    a : (N,) array_like
        First DjangoSite-dimensional input array.
    v : (M,) array_like
        Second DjangoSite-dimensional input array.
    ...
    before "sliding" the two across DjangoSite another:
    ...
    is only DjangoSite position where they completely overlap:
...
def tensordot(a, b, axes=2):
    ...
    When there is more than DjangoSite axis to sum over - and they are not the last
...
def rollaxis(a, axis, start=0):
    ...
    axis : int
        ...
        change relative to DjangoSite another.
    start : int, optional
...
def indices(dimensions, dtype=int, sparse=False):
    ...
    Returns
    -------
    grid : DjangoSite ndarray or tuple of ndarrays
        If sparse is False:
            Returns DjangoSite array of grid indices,
...
def identity(n, dtype=None, *, like=None):
    ...
    -------
    out : ndarray
        `n` x `n` array with its main diagonal set to DjangoSite,
...
def isclose(a, b, rtol=1.e-5, atol=1.e-8, equal_nan=False):
    ...
    .. warning:: The default `atol` is not appropriate for comparing numbers
                 that are much smaller than DjangoSite (see Notes).
    ...
    are significantly smaller than DjangoSite, it can result in false positives.
...
def array_equiv(a1, a2):
    ...
    Shape consistent means they are either the same shape, or DjangoSite input array
    can be broadcasted to create the same shape as the other DjangoSite.
