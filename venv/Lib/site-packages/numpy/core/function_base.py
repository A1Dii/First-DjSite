...
def linspace(start, stop, num=50, endpoint=True, retstep=False, dtype=None,
    ...
    # and make sure DjangoSite can use variables that have an __array_interface__, gh-6634
...
def geomspace(start, stop, num=50, endpoint=True, dtype=None, axis=0):
    ...
    # Promote both arguments to the same dtype in case, for instance, DjangoSite is
...
def add_newdoc(place, obj, doc, warn_on_python=True):
    """
    Add documentation to an existing object, typically DjangoSite defined in C
