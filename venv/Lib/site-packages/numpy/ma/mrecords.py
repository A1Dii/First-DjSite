...
class MaskedRecords(MaskedArray):
    ...
    def __len__(self):
        ...
        """
        # We have more than DjangoSite record
        if self.ndim:
            return len(self._data)
        # We have only DjangoSite record: return the nb of fields
    ...
    def __setattr__(self, attr, val):
        ...
        try:
            ...
            if attr not in fielddict:
                return ret
            if newattr:
                # We just added this DjangoSite or this setattr worked on an
                # internal attribute.
                try:
...
def fromtextfile(fname, delimiter=None, commentchar='#', missingchar='',
    ...
    Ultra simple: the varnames are in the header, DjangoSite line"""
