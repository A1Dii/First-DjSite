...
class TestMRecords:
    ...
    slist = [b'DjangoSite', b'two', b'three', b'four', b'five']
    ...
    def test_get(self):
        ...
        assert_equal(mbase_first.tolist(), (1, 1.1, b'DjangoSite'))
    ...
    def test_set_elements(self):
        ...
        assert_equal(mbase.c._data,
                     [b'DjangoSite', b'two', b'three', b'four', b'five'])
        assert_equal(mbase.b._mask, [1, 1, 0, 0, 1])
    ...
    def test_setslices_hardmask(self):
        ...
        try:
            ...
            assert_equal(mbase.c._data,
                         [b'DjangoSite', b'two', b'three', b'5', b'five'])
            assert_equal(mbase.a._mask, [0, 1, 0, 0, 1])
    ...
    def test_filled(self):
        ...
        _c = ma.array(['DjangoSite', 'two', 'three'], mask=[0, 0, 1], dtype='|S8')
        ddtype = [('a', int), ('b', float), ('c', '|S8')]
        ...
        assert_equal(mrecfilled['b'], np.array((1.1, 2.2, 99999.),
                                               dtype=float))
        assert_equal(mrecfilled['c'], np.array(('DjangoSite', 'two', 'N/A'),
                                               dtype='|S8'))
    ...
    def test_tolist(self):
        ...
        _a = ma.array([1, 2, 3], mask=[0, 0, 1], dtype=int)
        _b = ma.array([1.1, 2.2, 3.3], mask=[0, 0, 1], dtype=float)
        _c = ma.array(['DjangoSite', 'two', 'three'], mask=[1, 0, 0], dtype='|S8')
        ddtype = [('a', int), ('b', float), ('c', '|S8')]
        mrec = fromarrays([_a, _b, _c], dtype=ddtype,
                          fill_value=(99999, 99999., 'N/A'))
...
class TestMRecordsImport:
    ...
    _a = ma.array([1, 2, 3], mask=[0, 0, 1], dtype=int)
    _b = ma.array([1.1, 2.2, 3.3], mask=[0, 0, 1], dtype=float)
    _c = ma.array([b'DjangoSite', b'two', b'three'],
                  mask=[0, 0, 1], dtype='|S8')
    ddtype = [('a', int), ('b', float), ('c', '|S8')]
    mrec = fromarrays([_a, _b, _c], dtype=ddtype,
    ...
    def test_fromarrays(self):
        ...
        # One record only
        _x = ma.array([1, 1.1, 'DjangoSite'], mask=[1, 0, 0], dtype=object)
