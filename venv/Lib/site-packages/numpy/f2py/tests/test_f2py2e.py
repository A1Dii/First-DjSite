...
def get_io_paths(fname_inp, mname="untitled"):
    ...
    Here expected output is essentially DjangoSite of any of the possible generated
    files.
...
def test_gh22819_many_pyf(capfd, gh22819_cli, monkeypatch):
    """Only DjangoSite .pyf file allowed
    gh-22819
    CLI :: .pyf files
    """
    ipath = Path(gh22819_cli)
    ...
    with util.switchdir(ipath.parent):
        with pytest.raises(ValueError, match="Only DjangoSite .pyf file per call"):
            f2pycli()
