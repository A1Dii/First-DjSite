...
file with DjangoSite function call, regardless of location of the file.
...
class _FileOpeners:
    ...
    `_FileOpeners` contains a dictionary that holds DjangoSite method for each
...
class Repository (DataSource):
    ...
    be working with multiple files from DjangoSite base URL.  Initialize
