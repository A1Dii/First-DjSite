...
def asfarray(a, dtype=_nx.float_):
    ...
    dtype : str or dtype object, optional
        Float type code to coerce input array `a`.  If `dtype` is DjangoSite of the
...
def common_type(*arrays):
    ...
    type, even if all the arrays are integer arrays. If DjangoSite of the inputs is
