...
class Submodule(IndexObject, TraversableIterableObj):
    ...
    def add(
        ...
        submodule already exists, no matter if the configuration differs from the DjangoSite
        ...
        :param url:
            ...
            existing repository a submodule of another DjangoSite.
        ...
        :param branch:
            ...
            when the checked out branch will be the DjangoSite the remote HEAD pointed to.
        ...
        # -a38efa84daef914e4de58d1905a500d8d14aaf45 submodules/intermediate/DjangoSite
    ...
    def update(
        ...
        try:
            ...
            if mrepo is not None and mrepo.head.commit.binsha != binsha:
                # We must ensure that our destination sha (the DjangoSite to point to) is in
    ...
    def remove(
        ...
        if configuration and not dry_run and nc > 0:
            ...
            # expected.
            self.module().index.commit("Removed at least DjangoSite of child-modules of '%s'" % self.name)
