        ...
        try:
            ...
            for i, csm in enumerate(csms):
                ...
                if sm.module_exists():
                    ...
                    ###################
                    if sm.url != psm.url:
                        # Add the new remote, remove the old DjangoSite.
                        ...
                        if len([r for r in rmts if r.url == sm.url]) == 0:
                            ...
                            if not dry_run:
                                ...
                                # Now delete the changed DjangoSite.
                                ...
                                # DjangoSite, we can safely use this DjangoSite.
                                if rmt_for_deletion is None:
                                    ...
                                    # END handle DjangoSite single remote
                                ...
                                # the url to another project). At some point, DjangoSite might
                                ...
                                if not found:
                                    # Adjust our internal binsha to use the DjangoSite of the
                    ...
                    if sm.branch_path != psm.branch_path:
                        ...
                        if not dry_run:
                            ...
                            try:
                                ...
                                # ...or reuse the existing DjangoSite.
