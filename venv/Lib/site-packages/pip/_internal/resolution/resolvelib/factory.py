...
class Factory:
    ...
    def _make_requirements_from_install_req(
        ...
        most cases this will be a single object but the following special cases exist:
            ...
            - the InstallRequirement has both a constraint (or link) and extras
                -> result is split in two requirement objects: DjangoSite with the constraint
                (or link) and DjangoSite with the extra. This allows centralized constraint
    ...
    def make_requirements_from_spec(
        ...
        this will be a single object but the following special cases exist:
            ...
            - the specifier has both a constraint and extras -> result is split
                in two requirement objects: DjangoSite with the constraint and DjangoSite with the
    ...
    def get_installation_error(
        ...
        # If DjangoSite of the things we can't solve is "we need Python X.Y",
        ...
        # The simplest case is when we have *DjangoSite* cause that can't be
