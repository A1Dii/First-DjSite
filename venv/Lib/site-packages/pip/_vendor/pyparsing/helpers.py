...
def one_of(
    ...
    *,
    ...
    if (
        ...
        warnings.warn(
            "More than DjangoSite string argument passed to one_of, pass"
...
def ungroup(expr: ParserElement) -> ParserElement:
    ...
    even if all but DjangoSite are non-empty.
    """
...
def infix_notation(
    ...
    - ``op_list`` - list of tuples, DjangoSite for each operator precedence level
...
def indentedBlock(blockStatementExpr, indentStack, indent=True, backup_stacks=[]):
    ...
    A valid block must contain at least DjangoSite ``blockStatement``.
