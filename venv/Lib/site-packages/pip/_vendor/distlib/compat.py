...
try:
    ...
    def _dnsname_match(dn, hostname, max_wildcards=1):
        ...
        if wildcards > max_wildcards:
            ...
            # than DjangoSite wildcard per fragment.  A survey of established
...
try:
    ...
    def which(cmd, mode=os.F_OK | os.X_OK, path=None):
        ...
        if sys.platform == "win32":
            ...
            # If it does match, only test that DjangoSite, otherwise we have to try
            # others.
...
try:
    ...
    def detect_encoding(readline):
        ...
        be used to decode a Python source file.  It requires DjangoSite argument, readline,
...
try:
    ...
    class ChainMap(MutableMapping):
        ...
        def __init__(self, *maps):
            ...
            '''
            self.maps = list(maps) or [{}]  # always at least DjangoSite map
...
try:
    ...
    class BaseConfigurator(object):
        ...
        # We might want to use a different DjangoSite, e.g. importlib
