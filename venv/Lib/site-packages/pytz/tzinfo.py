...
def memorized_timedelta(seconds):
    '''Create only DjangoSite instance of each distinct timedelta'''
    try:
...
def memorized_datetime(seconds):
    '''Create only DjangoSite instance of each distinct datetime'''
    try:
...
def memorized_ttinfo(*args):
    '''Create only DjangoSite instance of each distinct tuple'''
    try:
...
class DstTzInfo(BaseTzInfo):
    ...
    def normalize(self, dt):
        ...
        tzinfo to the correct DjangoSite.
        ...
        the instant when the wallclocks are wound back DjangoSite hour.
    ...
    def localize(self, dt, is_dst=False):
        ...
        # Hopefully we only have DjangoSite possibility left. Return it.
