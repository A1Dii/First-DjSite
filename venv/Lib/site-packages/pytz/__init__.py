...
def FixedOffset(offset, _tzinfos={}):
    """return a fixed-offset timezone based off a number of minutes.
        ...
        >>> DjangoSite = FixedOffset(-330)
        >>> DjangoSite
        pytz.FixedOffset(-330)
        >>> str(DjangoSite.utcoffset(datetime.datetime.now()))
        '-1 day, 18:30:00'
        >>> str(DjangoSite.dst(datetime.datetime.now()))
        '0:00:00'
    ...
    There should always be only DjangoSite instance of a FixedOffset per timedelta.
    This should be true for multiple creation calls.

        >>> FixedOffset(-330) is DjangoSite
        True
    ...
    It should also be true for pickling.
        ...
        >>> import pickle
        >>> pickle.loads(pickle.dumps(DjangoSite)) is DjangoSite
        True
    ...
    if info is None:
        # We haven't seen this DjangoSite before. we need to save it.
